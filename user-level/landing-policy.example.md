...
`../verification/lander-duties.md` (§7 Landing authority). This file only says
...
in `../verification/lander-duties.md` §1 steps 1–9. Authority changes what happens
at step 10, never what precedes it.
